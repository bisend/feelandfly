    ...
    <section class="sec-space footer-1">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4">
                    <h2 class="section-title wht pb-25"> Последнее обновление </h2>
                    <ul class="post-widget">
                        <li>
                            <div class="blog-heading wht">
                                <a class="date" href="#"><span class="font-2 fsz-24">06</span> <b>Сен</b>  </a>
                                <a class="blog-title" href="blog.htm"> КУРТКА FEEL&FLY BUTTON BLACK </a>
                            </div>
                        </li>
                        <li>
                            <div class="blog-heading wht">
                                <a class="date" href="#"> <span class="font-2 fsz-24">04</span> <b>Авг</b>  </a>
                                <a class="blog-title" href="blog.htm"> ШОРТЫ FEEL&FLY CARGO BLACK </a>
                            </div>
                        </li>
                        <li>
                            <div class="blog-heading wht">
                                <a class="date" href="#"> <span class="font-2 fsz-24">04</span> <b>Авг</b>  </a>
                                <a class="blog-title" href="blog.htm"> КУРТКА FEEL&FLY PRADO NAVY</a>
                            </div>
                        </li>
                    </ul>
                </div>
